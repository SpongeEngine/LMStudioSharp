...
namespace SpongeEngine.LMStudioSharp.Providers.LmStudioSharpOpenAiCompatible
{
    public class LmStudioSharpOpenAiCompatibleProvider : ILmStudioSharpOpenAiCompatibleProvider
    {
        ...
        public LmStudioSharpOpenAiCompatibleProvider(
