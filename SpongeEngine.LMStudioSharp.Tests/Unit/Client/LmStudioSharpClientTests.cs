...
{
    public class LmStudioSharpClientTests : LmStudioTestBase
    {
        private readonly LmStudioSharpClient _sharpClient;

        public LmStudioSharpClientTests(ITestOutputHelper output) : base(output)
        {
            _sharpClient = new LmStudioSharpClient(new LmStudioOptions
            {
                BaseUrl = BaseUrl
            }, Logger);
        }
        ...
        {
            // Arrange
            var client = new LmStudioSharpClient(new LmStudioOptions
            {
                BaseUrl = BaseUrl,
                UseOpenAiApi = true
            }, Logger);
